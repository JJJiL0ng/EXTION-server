...
reasoning:
- "사용자에게 사용자의 메시지를 분석하여 사용할 도구를 설명해주세요."
- "예시: 사용자가 매출의 총합을 구하는 요청을 하였습니다. 엑셀 전용 에이전트를 호출하여 사용자의 요청을 해결하겠습니다"
- "예시: 사용자가 전체 데이터를 분석하여 인사이트를 제공해달라고 요청하였습니다. 전체 데이터를 읽고 분석하여 인사이트를 제공하겠습니다"
- "예시: 사용자가 서비스의 사용방식에 대한 질문을 하였습니다. extion.ai의 사용법에 대해 안내하겠습니다"

다음 JSON 형식으로 응답해주세요:
{{{{
  "intent": "의도_유형",
  "reasoning": "사용자의 요청 간단 분석 및 앞으로의 처리 방향"
}}}}
`;
