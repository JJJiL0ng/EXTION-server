/**
* [Task Executor] 사용자의 요청에 따라 셀 또는 범위에 스타일을 적용하는 명령을 생성하기 위한 프롬프트입니다.
* TaskType이 'APPLY_STYLE'일 때 사용됩니다.
...
2.  **적용 범위 확정**: 스타일을 적용할 셀 또는 범위를 식별합니다.
3.  **적용 방식 결정**:
