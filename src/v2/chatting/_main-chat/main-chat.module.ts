...
import { TableDataJsonParserModule } from '../../sheet/_table-data-json-parser/_table-data-json-parser.module';

@Module({
  imports: [PrismaModule, MainAiModule, TableDataJsonSaveModule, TableDataJsonParserModule],
